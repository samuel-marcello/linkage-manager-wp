 ...
 *
 * @since      1.0.0
 * @updated    1.0.1 - Added Elementor compatibility
 */
class Linkage_Shortcodes {
    ...
    public function linkage_list_shortcode( $atts ) {
        // Check if we're inside Elementor
        $is_elementor = defined( 'ELEMENTOR_VERSION' ) && \Elementor\Plugin::$instance->editor->is_edit_mode();
        ...
        $atts = shortcode_atts(
            array(
                ...
                'elementor_edit' => $is_elementor, // Flag for Elementor editor
            ),
            $atts,
            'linkage_list'
        );
        ...
        // Add a wrapper div with a special class for Elementor compatibility
        echo '<div class="linkage-manager-shortcode-wrapper" data-shortcode="linkage_list">';
    ...
    public function linkage_detail_shortcode( $atts ) {
        ...
        // Add a wrapper div with a special class for Elementor compatibility
        echo '<div class="linkage-manager-shortcode-wrapper" data-shortcode="linkage_detail">';
